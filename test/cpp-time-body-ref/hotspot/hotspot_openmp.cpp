...
int main(int argc, char **argv)
{
    ...
    unsigned long long start_time = hclib_current_time_ns(); compute_tran_temp(result,sim_time, temp, power, grid_rows, grid_cols) unsigned long long end_time = hclib_current__time_ns(); printf("\nHCLIB TIME %llu ns\n", end_time - start_time);;
