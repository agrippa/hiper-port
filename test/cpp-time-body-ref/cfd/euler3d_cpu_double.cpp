...
printf("pragma53_omp_parallel %llu ns", parallel_for_end - parallel_for_start); } 
...
const unsigned long long parallel_for_end = current_time_ns();
printf("pragma102_omp_parallel %llu ns", parallel_for_end - parallel_for_start); } 
...
const unsigned long long parallel_for_end = current_time_ns();
printf("pragma186_omp_parallel %llu ns", parallel_for_end - parallel_for_start); } 
...
const unsigned long long parallel_for_end = current_time_ns();
printf("pragma317_omp_parallel %llu ns", parallel_for_end - parallel_for_start); } 
