...
for (si = 0; si < nseqs; si++) {
  ...
  } ; unsigned long long ____hclib_end_time = hclib_current_time_ns(); printf("pragma450_omp_parallel %llu ns\n", ____hclib_end_time - ____hclib_start_time); // end parallel for (i)
   }
   return 0;
}
