...
for FILE in $FILES; do
    ...
    CUDA_OUTPUT=$SCRIPT_DIR/test-output/$FILENAME.cuda
    CUDA_REFERENCE=$(dirname $DIRNAME)-cuda-ref/$TESTNAME/$FILENAME
    ...
    $CUDA_CMD &> transform.cuda.log
    compare_outputs $CUDA_REFERENCE $FILE $CUDA_OUTPUT
