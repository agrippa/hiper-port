...
static void pragma108_hclib_async(void *____arg, const int ___iter0);
...
for (int t = 0; t < rows-1; t++) {
        ...
        dst = temp;
 { 
pragma108 *new_ctx = (pragma108 *)malloc(sizeof(pragma108));
new_ctx->t_ptr = &(t);
...
domain[0].stride = 1;
domain[0].tile = 1;
hclib_future_t *fut = hclib_forasync_future((void *)pragma108_hclib_async, new_ctx, NULL, 1, domain, FORASYNC_MODE_RECURSIVE);
...
static void pragma108_hclib_async(void *____arg, const int ___iter0) {
    pragma108 *ctx = (pragma108 *)____arg;
    int min; min = ctx->min;
    hclib_start_finish();
    do {
    int n;     n = ___iter0;
