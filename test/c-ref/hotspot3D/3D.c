...
static void pragma164_hclib_async(void *____arg, const int ___iter0);
...
{  
...

    {
        ...
        do {
            int z; 
 { 
pragma164 *new_ctx = (pragma164 *)malloc(sizeof(pragma164));
new_ctx->z = z;
...
domain[0].stride = 1;
domain[0].tile = 1;
hclib_future_t *fut = hclib_forasync_future((void *)pragma164_hclib_async, new_ctx, NULL, 1, domain, FORASYNC_MODE_RECURSIVE);
...
static void pragma164_hclib_async(void *____arg, const int ___iter0) {
    pragma164 *ctx = (pragma164 *)____arg;
    int z; z = ctx->z;
    hclib_start_finish();
    do {
    z = ___iter0;
